<x-app-layout>
 <title>Biometric Digital ID - BVN Search</title>
      <div class="page-body">
        ...
        <div class="col-12">
            <div class="card border-0 shadow-sm overflow-hidden" style="border-radius: 1.25rem;">
                <div class="card-body p-4 bg-white">
                    <form method="GET" action="{{ route('bvn-search.index') }}">
                            ...
                            <div class="col-lg-5">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="search" class="form-control border-start-0 bg-light py-2" 
                                           placeholder="Search Reference, Agent Name, Phone..." value="{{ request('search') }}">
                                </div>
                            </div>
                            <div class="col-lg-3">
                                <div class="input-group">
                            ...
                            <div class="col-lg-4">
                                <div class="d-flex gap-2">
                                    ...
                                    @if(request('status') || request('search'))
                                        <a href="{{ route('bvn-search.index') }}" class="btn btn-outline-danger px-4 py-2 d-flex align-items-center justify-content-center">
                ...
                <table class="table table-hover align-middle mb-0">
                    <thead class="bg-light text-muted small text-uppercase fw-bold">
                        <tr>
                            ...
                            <th class="py-3">Transaction Info</th>
                            <th class="py-3">Agent Details</th>
                            <th class="py-3">BVN Data</th>
                    ...
                    <tbody>
                        @forelse ($enrollments as $enrollment)
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex flex-column">
                                        <span class="text-dark fw-medium small">Phone: {{ $enrollment->number }}</span>
                                        <small class="text-muted">BVN: {{ $enrollment->service_field_name ?? $enrollment->bvn ?? 'N/A' }}</small>
                                    </div>
                                </td>
                                ...
                                <td class="pe-4 text-end">
                                    <a href="{{ route('bvn-search.show', $enrollment->id) }}" class="btn btn-icon btn-light btn-sm rounded-circle shadow-sm" data-bs-toggle="tooltip" title="View Details">
                            ...
                            <tr>
                                <td colspan="7" class="text-center py-5">
                                    <div class="py-4">
                                        ...
                                        <h6 class="text-muted fw-normal">No search records found.</h6>
                                        @if(request('search') || request('status'))
                                            <a href="{{ route('bvn-search.index') }}" class="btn btn-link btn-sm mt-2">Clear all filters</a>
                                        @endif
                                    </div>
                                </td>
                            </tr>
