            ...
            <div class="col-12">
                <div class="card shadow-sm border-0">
                    <div class="card-body d-flex justify-content-between align-items-center">
                        <div>
                            <h4 class="mb-0 fw-bold text-primary">BVN Search Details</h4>
                            <p class="text-muted mb-0">View and manage BVN Search request</p>
                        </div>
                        <div class="d-flex gap-2">
                            <a href="{{ route('bvn-search.index') }}" class="btn btn-light">
                    ...
                    <div class="card-body">
                        <div class="row g-4">
                            ...
                            <div class="col-md-6">
                                ...
                                <p class="fw-medium mb-0">{{ $enrollmentInfo->number }}</p>
                            </div>

                            {{-- Bactch id --}}
                            <div class="col-md-6">
                                <label class="form-label text-muted small text-uppercase fw-bold">BVN ID</label>
    ...
    <div class="modal fade" id="updateStatusModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content border-0 shadow-lg">
                ...
                <form method="POST" action="{{ route('bvn-search.update', $enrollmentInfo->id) }}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="modal-body p-4">
                        ...
                        {{-- BVN (Optional) --}}
                        <div class="mb-3">
                            <label for="bvn" class="form-label fw-semibold">BVN (Optional)</label>
                            <input type="text" class="form-control" id="bvn" name="bvn" 
                                placeholder="Enter BVN (Optional)" 
                                value="{{ old('bvn', $enrollmentInfo->bvn) }}">
                             <small class="text-muted">
                                <i class="ti ti-info-circle me-1"></i>If available
                            </small>
                        </div>
