<x-app-layout>
 <title>Biometric Digital ID - NIN Personalisation</title>
      <div class="page-body">
        ...
        <div class="col-12">
            <div class="card border-0 shadow-sm overflow-hidden" style="border-radius: 1.25rem;">
                <div class="card-body p-4 bg-white">
                    <form method="GET" action="{{ route('nin-personalisation.index') }}">
                            ...
                            <div class="col-lg-4">
                                <div class="d-flex gap-2">
                                    ...
                                    @if(request('status') || request('search') || request('bank'))
                                        <a href="{{ route('nin-personalisation.index') }}" class="btn btn-outline-danger px-4 py-2 d-flex align-items-center justify-content-center">
                        ...
                        @forelse ($enrollments as $enrollment)
                            <tr>
                                ...
                                <td class="pe-4 text-end">
                                    <a href="{{ route('nin-personalisation.show', $enrollment->id) }}" class="btn btn-icon btn-light btn-sm rounded-circle shadow-sm" data-bs-toggle="tooltip" title="View Details">
                                ...
                                <td colspan="7" class="text-center py-5">
                                    <div class="py-4">
                                        ...
                                        @if(request('search') || request('status'))
                                            <a href="{{ route('nin-personalisation.index') }}" class="btn btn-link btn-sm mt-2">Clear all filters</a>
                                        @endif
                                    </div>
                                </td>
                            </tr>
