        ...
        <div class="col-12">
            <div class="card border-0 shadow-sm overflow-hidden" style="border-radius: 1.25rem;">
                <div class="card-body p-4 bg-white">
                    <form method="GET" action="{{ route('bvnmod.index') }}">
                            ...
                            <div class="col-lg-4">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="search" class="form-control border-start-0 bg-light py-2" 
                                           placeholder="Search BVN, NIN, Agent, Ref..." value="{{ request('search') }}">
                                </div>
                            </div>
                            <div class="col-lg-3">
                                <div class="input-group">
                            ...
                            <div class="col-lg-3">
                                <div class="d-flex gap-2">
                                    ...
                                    @if(request('status') || request('search') || request('bank'))
                                        <a href="{{ route('bvnmod.index') }}" class="btn btn-outline-danger px-4 py-2 d-flex align-items-center justify-content-center">
    ...
    <div class="card border-0 shadow-sm" style="border-radius: 1.25rem;">
        <div class="card-header bg-white py-4 border-bottom-0 d-flex justify-content-between align-items-center">
            <h5 class="mb-0 fw-bold text-dark d-flex align-items-center">
                <i class="ti ti-edit me-2 text-primary fs-22"></i>
                BVN Modification Requests
            </h5>
                    ...
                    <tbody>
                        @forelse ($enrollments as $enrollment)
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="d-flex flex-column">
                                            <span class="fw-bold text-dark">{{ $enrollment->bvn }}</span>
                                            <small class="text-muted">Ref: {{ $enrollment->reference }}</small>
                                        </div>
                                    </div>
                                </td>
                                <td>
                                ...
                                <td>
                                    <div class="d-flex flex-column">
                                        <span class="text-dark fw-medium small">{{ $enrollment->bank ?? 'No Bank' }}</span>
                                        <small class="text-primary fw-bold">{{ $enrollment->service_field_name ?? $enrollment->field_name }}</small>
                                    </div>
                                </td>
                                ...
                                <td class="pe-4 text-end">
                                    <a href="{{ route('bvnmod.show', $enrollment->id) }}" class="btn btn-icon btn-light btn-sm rounded-circle shadow-sm" data-bs-toggle="tooltip" title="View Details">
                            ...
                            <tr>
                                <td colspan="7" class="text-center py-5">
                                    <div class="py-4">
                                        ...
                                        <h6 class="text-muted fw-normal">No modification records found.</h6>
                                        @if(request('search') || request('status') || request('bank'))
                                            <a href="{{ route('bvnmod.index') }}" class="btn btn-link btn-sm mt-2">Clear all filters</a>
                                        @endif
                                    </div>
                                </td>
                            </tr>
