            ...
            <div class="col-12">
                <div class="card shadow-sm border-0">
                    <div class="card-body d-flex justify-content-between align-items-center">
                        <div>
                            <h4 class="mb-0 fw-bold text-primary">NIN Modification Details</h4>
                            <p class="text-muted mb-0">View and manage NIN modification request</p>
                        </div>
                        <div class="d-flex gap-2">
                            <a href="{{ route('ninmod.index') }}" class="btn btn-light">
                ...
                <div class="card shadow-sm border-0 mb-4">
                    ...
                    <div class="card-body">
                        <div class="row g-4">
                            ...
                            {{-- Modification Type  --}}
                            <div class="col-md-6">
                                <label class="form-label text-muted small text-uppercase fw-bold">Enrolment Bank</label>
                                <p class="fw-medium mb-0">{{ $enrollmentInfo->bank ?? $enrollmentInfo->service_name }}</p>
                            </div>
    ...
    <div class="modal fade" id="updateStatusModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content border-0 shadow-lg">
                ...
                <form method="POST" action="{{ route('ninmod.update', $enrollmentInfo->id) }}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
        ...
        document.addEventListener("DOMContentLoaded", function () {
            ...
            if (btnCheckStatus) {
                btnCheckStatus.addEventListener("click", function () {
                    ...
                    fetch(`/nin-modification/${id}/check-status`)
