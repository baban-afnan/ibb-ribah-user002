<x-app-layout>
 <title>IBB RIBAH - First Account Requests</title>
      <div class="page-body">
    <div class="container-fluid">
      <div class="page-title">
        <div class="row">
          <div class="col-sm-6 col-12">
            <h3 class="mb-0 fw-bold">First Account Opening</h3>
          </div>
        </div>
      </div>
    </div>
            ...
            <div class="financial-card shadow-sm h-100 p-4" style="background: var(--primary-gradient);">
                <div class="d-flex justify-content-between align-items-start position-relative z-1">
                    <div>
                        ...
                        <small class="text-white-50 fs-12 fw-medium">Pending Review</small>
                    </div>
            ...
            <div class="financial-card shadow-sm h-100 p-4" style="background: var(--info-gradient);">
                <div class="d-flex justify-content-between align-items-start position-relative z-1">
                    <div>
                        ...
                        <small class="text-white-50 fs-12 fw-medium">In Progress</small>
                    </div>
                    <div class="avatar avatar-lg bg-white bg-opacity-25 rounded-3">
            ...
            <div class="financial-card shadow-sm h-100 p-4" style="background: var(--success-gradient);">
                <div class="d-flex justify-content-between align-items-start position-relative z-1">
                    <div>
                        ...
                        <small class="text-white-50 fs-12 fw-medium">Completed Successfully</small>
                    </div>
                    <div class="avatar avatar-lg bg-white bg-opacity-25 rounded-3">
            ...
            <div class="financial-card shadow-sm h-100 p-4" style="background: var(--danger-gradient);">
                <div class="d-flex justify-content-between align-items-start position-relative z-1">
                    <div>
                        ...
                        <small class="text-white-50 fs-12 fw-medium">Failed or Rejected</small>
                    </div>
                    <div class="avatar avatar-lg bg-white bg-opacity-25 rounded-3">
        ...
        <div class="col-12">
            <div class="card border-0 shadow-sm overflow-hidden" style="border-radius: 1.25rem;">
                <div class="card-body p-4 bg-white">
                    <form method="GET" action="{{ route('first-account.index') }}">
                            ...
                            <div class="col-lg-5">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="search" class="form-control border-start-0 bg-light py-2" 
                                           placeholder="Search Reference, NIN, BVN..." value="{{ request('search') }}">
                                </div>
                            </div>
                            <div class="col-lg-3">
                                <div class="input-group">
                            ...
                            <div class="col-lg-4">
                                <div class="d-flex gap-2">
                                    <button type="submit" class="btn btn-primary px-4 py-2 d-flex align-items-center justify-content-center flex-grow-1">
                                        <i class="ti ti-filter me-2 fs-18"></i> Filter
                                    </button>
                                    @if(request('status') || request('search'))
                                        <a href="{{ route('first-account.index') }}" class="btn btn-outline-danger px-4 py-2 d-flex align-items-center justify-content-center">
    ...
    <div class="card border-0 shadow-sm" style="border-radius: 1.25rem;">
        <div class="card-header bg-white py-4 border-bottom-0 d-flex justify-content-between align-items-center">
            <h5 class="mb-0 fw-bold text-dark d-flex align-items-center">
                ...
                First Account Requests
            </h5>
            <div class="d-flex gap-2">
                <a href="{{ route('first-account.export-csv') }}" class="btn btn-outline-success btn-sm">
                    <i class="ti ti-file-type-csv me-1"></i> CSV
                </a>
                <a href="{{ route('first-account.export-excel') }}" class="btn btn-outline-primary btn-sm">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        ...
                                        <span class="fw-bold text-dark">{{ $enrollment->reference }}</span>
                                    </div>
                                </td>
                                <td>
                                ...
                                <td>
                                    <div class="d-flex flex-column">
                                        <span class="small text-dark">BVN: {{ $enrollment->bvn ?? 'N/A' }}</span>
                                        <span class="small text-muted">NIN: {{ $enrollment->nin ?? 'N/A' }}</span>
                                    </div>
                                </td>
                                ...
                                <td class="pe-4 text-end">
                                    <a href="{{ route('first-account.show', $enrollment->id) }}" class="btn btn-icon btn-light btn-sm rounded-circle shadow-sm" data-bs-toggle="tooltip" title="View Details">
                            ...
                            <tr>
                                <td colspan="7" class="text-center py-5">
                                    <div class="py-4">
                                        ...
                                        <h6 class="text-muted fw-normal">No first account opening records found.</h6>
                                    </div>
                                </td>
                            </tr>
                        @endforelse
...
<style>
    ...
    .form-select, .form-control { border-color: #f1f3f4; }
    .form-select:focus, .form-control:focus { border-color: #6366f1; box-shadow: 0 0 0 0.25rem rgba(99, 102, 241, 0.1); }
</style>
