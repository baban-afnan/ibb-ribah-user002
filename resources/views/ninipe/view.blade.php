<x-app-layout>
    <title>Biometric Digital ID - NIN - IPE details</title>
            ...
            <div class="col-12">
                <div class="card shadow-sm border-0">
                    <div class="card-body d-flex justify-content-between align-items-center">
                        <div>
                            <h4 class="mb-0 fw-bold text-primary">NIN IPE Details</h4>
                            <p class="text-muted mb-0">View and manage NIN IPE request</p>
                        </div>
                        <div class="d-flex gap-2">
                            <a href="{{ route('ninipe.index') }}" class="btn btn-light">
        ...
        <div class="modal fade" id="updateStatusModal" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content border-0 shadow-lg">
                    ...
                    <form method="POST" action="{{ route('ninipe.update', $enrollmentInfo->id) }}" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
