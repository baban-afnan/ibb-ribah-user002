            ...
            <div class="col-12">
                <div class="card shadow-sm border-0">
                    <div class="card-body d-flex justify-content-between align-items-center">
                        <div>
                            <h4 class="mb-0 fw-bold text-primary">VNIN to NIBSS Details</h4>
                            <p class="text-muted mb-0">View and manage VNIN to NIBSS request</p>
                        </div>
                        <div class="d-flex gap-2">
                            <a href="{{ route('vnin-nibss.index') }}" class="btn btn-light">
                ...
                <div class="card shadow-sm border-0 mb-4">
                    ...
                    <div class="card-body">
                        <div class="row g-4">
                            ...
                            <div class="col-md-6">
                                <label class="form-label text-muted small text-uppercase fw-bold">Request ID</label>
                                <p class="fw-medium mb-0">{{ $enrollmentInfo->request_id }}</p>
                            </div>
    ...
    <div class="modal fade" id="updateStatusModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content border-0 shadow-lg">
                ...
                <form method="POST" action="{{ route('vnin-nibss.update', $enrollmentInfo->id) }}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
