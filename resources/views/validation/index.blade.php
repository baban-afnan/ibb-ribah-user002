<x-app-layout>
 <title>Biometric Digital ID - NIN - Validation</title>
      <div class="page-body">
                            ...
                            <div class="col-lg-4">
                                <div class="d-flex gap-2">
                                    ...
                                    @if(request('status') || request('search'))
                                        <a href="{{ route('validation.index') }}" class="btn btn-outline-danger px-4 py-2 d-flex align-items-center justify-content-center">
                        ...
                        @forelse ($enrollments as $enrollment)
                            <tr>
                                ...
                                <td class="pe-4 text-end">
                                    <a href="{{ route('validation.show', $enrollment->id) }}" class="btn btn-icon btn-light btn-sm rounded-circle shadow-sm" data-bs-toggle="tooltip" title="View Details">
                                ...
                                <td colspan="7" class="text-center py-5">
                                    <div class="py-4">
                                        ...
                                        @if(request('search') || request('status'))
                                            <a href="{{ route('validation.index') }}" class="btn btn-link btn-sm mt-2">Clear all filters</a>
                                        @endif
                                    </div>
                                </td>
                            </tr>
